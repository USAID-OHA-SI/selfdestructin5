# PURPOSE: MD Asks for Edits to MDB Tables During Q3 Data Review
# AUTHOR: Maddie Medina | SI 
# LICENSE: MIT
# DATE: 2021-08-31
...
mdb_out <- "~maddiemedina/Documents/MSD/MDB"
...
#Global Table with Some of the Edits Requested:
